...
You can start writing assets in `fivetran_dbtcloud_simple/assets/`. The assets are automatically loaded into the Dagster repository as you define them.
...
Tests are in the `fivetran_dbtcloud_simple_tests` directory and you can run tests using `pytest`:

```bash
pytest fivetran_dbtcloud_simple_tests
```
